...
::Platform::Object^ GetReferenceTypeMember_OutputList(::Platform::Object^ instance)
{
    return safe_cast<TDeclaringType^>(instance)->OutputList;
}

template<typename TDeclaringType>
::Platform::Object^ GetReferenceTypeMember_Out(::Platform::Object^ instance)
{
    return safe_cast<TDeclaringType^>(instance)->Out;
}

template<typename TDeclaringType>
::Platform::Object^ GetReferenceTypeMember_In(::Platform::Object^ instance)
{
    return safe_cast<TDeclaringType^>(instance)->In;
}

template<typename TDeclaringType>
::Platform::Object^ GetReferenceTypeMember_A(::Platform::Object^ instance)
{
    return safe_cast<TDeclaringType^>(instance)->A;
}

template<typename TDeclaringType>
::Platform::Object^ GetReferenceTypeMember_Var(::Platform::Object^ instance)
{
    return safe_cast<TDeclaringType^>(instance)->Var;
}
...
void SetReferenceTypeMember_OutputList(::Platform::Object^ instance, ::Platform::Object^ value)
{
    safe_cast<TDeclaringType^>(instance)->OutputList = safe_cast<TValue^>(value);
}

template<typename TDeclaringType, typename TValue>
void SetReferenceTypeMember_Out(::Platform::Object^ instance, ::Platform::Object^ value)
{
    safe_cast<TDeclaringType^>(instance)->Out = safe_cast<TValue^>(value);
}

template<typename TDeclaringType, typename TValue>
void SetReferenceTypeMember_In(::Platform::Object^ instance, ::Platform::Object^ value)
{
    safe_cast<TDeclaringType^>(instance)->In = safe_cast<TValue^>(value);
}

template<typename TDeclaringType, typename TValue>
void SetReferenceTypeMember_A(::Platform::Object^ instance, ::Platform::Object^ value)
{
    safe_cast<TDeclaringType^>(instance)->A = safe_cast<TValue^>(value);
}

template<typename TDeclaringType, typename TValue>
void SetReferenceTypeMember_Var(::Platform::Object^ instance, ::Platform::Object^ value)
{
    safe_cast<TDeclaringType^>(instance)->Var = safe_cast<TValue^>(value);
}
...
TypeInfo TypeInfos[] = 
{
    ...
    nullptr, nullptr, nullptr, nullptr,
    -1,
    6, 0, ::Windows::UI::Xaml::Interop::TypeKind::Metadata,
    false, true,  false, false,
    //   6
    ...
    false, true,  false, false,
    //   7
    L"Windows.Foundation.Collections.IVector`1<App1.VarDisplay>", L"",
    nullptr, &CollectionAdd<::Windows::Foundation::Collections::IVector<::App1::VarDisplay^>, ::App1::VarDisplay^>, nullptr, nullptr,
    -1,
    6, 0, ::Windows::UI::Xaml::Interop::TypeKind::Metadata,
    false, false, true,  false,
    //   8
    L"Windows.Foundation.Collections.IVector`1<App1.OutputDisplay>", L"",
    nullptr, &CollectionAdd<::Windows::Foundation::Collections::IVector<::App1::OutputDisplay^>, ::App1::OutputDisplay^>, nullptr, nullptr,
    -1,
    6, 0, ::Windows::UI::Xaml::Interop::TypeKind::Metadata,
    false, false, true,  false,
...
{
    //   0 - App1.MainPage.OutputList
    L"OutputList",
    &GetReferenceTypeMember_OutputList<::App1::MainPage>,
    &SetReferenceTypeMember_OutputList<::App1::MainPage, ::Windows::Foundation::Collections::IVector<::App1::OutputDisplay^>>,
    8, // Windows.Foundation.Collections.IVector`1<App1.OutputDisplay>
    -1,
    false, false, false,
    //   1 - App1.MainPage.A
    L"A",
    &GetReferenceTypeMember_A<::App1::MainPage>,
    &SetReferenceTypeMember_A<::App1::MainPage, ::Windows::Foundation::Collections::IVector<::App1::VarDisplay^>>,
    7, // Windows.Foundation.Collections.IVector`1<App1.VarDisplay>
    -1,
    false, false, false,
    //   2 - App1.VarDisplay.Var
    L"Var",
    &GetReferenceTypeMember_Var<::App1::VarDisplay>,
    &SetReferenceTypeMember_Var<::App1::VarDisplay, ::Platform::String>,
    1, // String
    -1,
    false, false, false,
    //   3 - App1.VarDisplay.Name
    L"Name",
    &GetReferenceTypeMember_Name<::App1::VarDisplay>,
    &SetReferenceTypeMember_Name<::App1::VarDisplay, ::Platform::String>,
    1, // String
    -1,
    false, false, false,
    //   4 - App1.OutputDisplay.Out
    L"Out",
    &GetReferenceTypeMember_Out<::App1::OutputDisplay>,
    &SetReferenceTypeMember_Out<::App1::OutputDisplay, ::Platform::String>,
    1, // String
    -1,
    false, false, false,
    //   5 - App1.OutputDisplay.In
    L"In",
    &GetReferenceTypeMember_In<::App1::OutputDisplay>,
    &SetReferenceTypeMember_In<::App1::OutputDisplay, ::Platform::String>,
    1, // String
    -1,
    false, false, false,
};
